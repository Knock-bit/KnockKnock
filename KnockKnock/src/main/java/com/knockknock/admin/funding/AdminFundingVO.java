...
public class AdminFundingVO {
	...
	public AdminFundingVO() { }

	public AdminFundingVO(int cfIdx, int cpIdx, String cfGoal, String cfTitle, String cfContent, Date cfEnddate,
	...
	public void setCfRn(int cfRn) {
		this.cfRn = cfRn;
	}

	@Override
	public String toString() {
		return "AdminFundingVO [cfIdx=" + cfIdx + ", cpIdx=" + cpIdx + ", cfGoal=" + cfGoal + ", cfTitle=" + cfTitle
				...
				+ ", cfFile=" + cfFile + ", ccName=" + ccName + ", uIdx=" + uIdx + ", cfKeyword1=" + cfKeyword1
