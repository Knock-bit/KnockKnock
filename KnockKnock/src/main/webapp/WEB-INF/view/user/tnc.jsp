			...
			<li class="checkBox check01">
				<ul class="clearfix">
					...
					<li class="checkAllBtn"><input type="checkbox" name="chkAll"
						id="checkAll" class="chkAll" onclick="cAll()"></li>
				</ul>
			</li>
			<li class=" checkBox check02">
				<ul class="clearfix">
					...
					<li class="checkBtn"><input type="checkbox" name="chk"
						id="chk1" onclick="chk1()"></li>
				</ul> <textarea name="" id="">녹녹에 오신 여러분을 환영합니다.
			...
			<li class="checkBox check03">
				<ul class="clearfix">
					...
					<li class="checkBtn"><input type="checkbox" id="chk2"
						name="chk" onclick="chk2()"></li>
				</ul> <textarea name="" id="">1. 수집하는 개인정보
