...
제2조 (용어의 정의)
본 약관에서 사용되는 용어의 정의는 본 약관에서 별도로 규정하는 경우를 제외하고 녹녹 구매이용약관 제2조를 따릅니다.
...
③ 녹녹 구매이용약관의 내용 중 성질상 판매 서비스에 적용될 수 있는 내용은 제2항과 동일하게 적용됩니다. 본 약관에 따라 판매회원으로 가입하고자 하는 자는 구매이용약관의 내용을 숙지하고 본 항의 내용에 동의하는 것임을 확인합니다.
...
② 상품과 용역의 판매가격(표준마진율, 배송비, 서비스이용료 등을 판매자가 직접 고려 및 판단해야 합니다) 및 기타 상품과 용역의 광고∙홍보를 포함하는 모든 판매활동은 판매회원 스스로 판단 및 결정하며, 본인의 행위에 대한 법적 책임을 부담하여야 합니다. 만약 판매회원이 법령 및 본 약관을 위배하는 행위를 한 경우에 회사는 본 약관 제16조 및 제17조에 따라 이용자(녹녹를 이용하는 회원 및 비회원, 이하 같음) 보호와 회사의 손해를 최소화 할 수 있는 조치를 취할 수 있습니다.
...
8. 다른 오픈마켓이나 인터넷쇼핑몰 등에 임의로 최저가를 등록하는 행위 등으로 녹녹의 할인쿠폰 발행을 유도한 후 구매자가 해당 쿠폰을 적용한 조건으로 판매하는 행위
...
④ 이 약관과 이용정책, 개별약관에서 정하지 않은 사항은 구매이용약관을 따르며, 구매이용약관에서 정하지 않은 사항은 관련 법령과 상관례를 따릅니다.
            ...
            <li class="checkBox check03">
                ...
                <textarea name="" id="">제1조 (목적)
이 약관은 녹녹(이하 "회사")가 운영하는 녹녹(웹사이트 이하 "녹녹")에서 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 상품 또는 용역을 거래하는 자 간의 권리, 의무 등 기타 필요사항, 회원과 회사간의 권리, 의무, 책임사항 및 회원의 서비스 이용절차 등에 관한 사항을 규정함을 목적으로 합니다.

제2조 (용어의 정의)
① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
1. 녹녹: 자유로운 상품 또는 용역(이하 "상품")의 거래를 위하여 회사가 제공하는 실시간 전자상거래 시스템과 그 운영을 위한 웹사이트를 말합니다.
...
가. 일반회원(구매고객): 녹녹에서 상품구매 및 구매와 관련하여 제공되는 서비스를 이용할 수 있는 회원을 말합니다. 일반회원은 개인구매회원과 사업자구매회원으로 구분됩니다.
a. 개인구매회원: 구매만을 목적으로 하는 회원으로 만 14세 이상이면 누구나 가입할 수 있음(국내에 거주하는 외국인 포함)
b. 사업자구매회원: 구매를 목적으로 사업자 정보로 등록한 회원
나. 셀러회원(구매판매고객): 녹녹에서 상품 구매 및 관련 서비스와 판매회원약관(이하 "판매이용약관")상의 서비스를 이용할 수 있는 회원을 말합니다. 셀러회원은 개인셀러회원과 사업자셀러회원으로 구분됩니다.
...
12. 캐시: 녹녹에서 회원이 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유로 환불을 요청했을 때 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어려워 회사가 회원에게 환불해야 하는 현금 환불수단으로 활용되는 정보를 말합니다.
...
18. 분쟁조정센터: 녹녹를 통한 거래에서 분쟁이 발생하면 판매자와 구매자가 자율적으로 해결하는 것이 원칙이지만, 분쟁의 합리적이고 원활한 조정을 위하여 예외적으로 회사가 설치·운영하는 분쟁조정기구를 말합니다.
② 제1항에서 정의되지 않은 용어의 의미는 관련 법령 및 일반적인 거래관행을 따릅니다.

제3조 (적용 범위 및 효력 우선순위)
① 이 약관에서 제1장(총칙), 제3장(기타사항)은 전체 서비스에 적용되며, 제2장은 녹녹(통신판매중개) 서비스에 구분하여 적용됩니다.
...
② 회사는 필요하면 특정 서비스에 적용될 사항(이하 “개별약관”)을 정하여 이를 녹녹 등을 통하여 공지할 수 있습니다.
③ 회사는 필요하면 서비스 이용과 관련된 세부적인 내용(이하 "이용정책")을 정하여 이를 녹녹 등을 통하여 공지할 수 있습니다.
④ 개별약관이나 이용정책의 변경이 있으면 회사는 변경 내용의 효력발생일 7일 이전에 녹녹를 통하여 해당 변경 사항을 공지합니다.
...
⑥ 녹녹에서 제공하는 서비스를 통하여 거래가 성사 되었을 때 회사는 판매자와 구매자 간에 물품거래와 배송 등의 이행과 관련하여 필요한 범위 내에서 구매자의 개인정보를 판매자에게 제공합니다.
...
8. 녹녹 구매/판매이용약관의 적용을 받는 자가 해당 약관을 위반한 경우
...
마. 회원이 이 약관에 위배되는 행위를 하거나 이 약관에서 정한 해지사유가 발생한 경우(녹녹 판매회원 약관의 적용을 받는 자가 해당 약관을 위반한 경우 포함)
...
제13조 (서비스 기간과 중단)
① 회원의 서비스 기간은 녹녹에 서비스를 신청하여 이용승낙을 받은 날로부터 서비스 이용계약을 해지할 때까지 입니다.
...
제14조 (서비스 이용료)
회사는 녹녹의 일부 특정 서비스나 기능을 제공할 때 이용료를 부과할 수 있으며, 그 상세한 내용은 개별 약관, 별도 신청서를 통해 정할 수 있습니다.
...
제16조 (포인트, 캐시)
① 녹녹에서 회원이 무통장입금, 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유가 발생하면 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어렵거나 회원의 설정으로 인하여 회사는 회원에게 캐시를 이용하여 회원에게 환불해 줄 수 있습니다. 이 때, 캐시는 현금출금만 가능하며, 캐시 1원은 현금 1원의 의미가 있습니다.
...
④ 본 조 제3항에 언급된 회사의 사용권은 녹녹 서비스를 운영하는 동안에만 확정적으로 유효합니다.
...
⑦ 이용자가 녹녹를 이용하여 얻은 정보를 회사의 승낙 없이 복제, 송신, 출판, 배포, 방송, 기타 방법으로 이용하거나 제3자에게 이용하게 할 때 그에 대한 책임은 이용자 본인에게 있습니다.
⑧ 회원은 녹녹 내에서 자신의 저작권이 침해되면 회사가 운영하는 신고센터 제도를 이용하여 자신의 정당한 권리를 보호받을 수 있습니다.
...
5. 기타 제1호 내지 제4호에 준하는 중대한 사유로 말미암아 회사가 제공하는 녹녹 서비스의 원활한 진행을 방해하는 것으로 판단되는 경우
...
② 회사는 녹녹를 통하여 이루어지는 구매자와 판매자 간의 거래와 관련하여 판매의사 또는 구매의사의 존부 및 진정성, 등록 상품의 품질, 완전성, 안정성, 적법성 및 타인의 권리에 대한 비침해성, 구매자 또는 판매자가 입력하는 정보 및 그 정보를 통하여 링크된 URL에 게재된 자료의 진실성 또는 적법성 등 일체를 보증하지 않습니다. 다만, 등록된 상품 관련 정보가 법규 위반이나 저작권 침해가 명백한 경우, 또는 저작권 등 권리를 침해받았다고 주장하는 자가 그 침해의 정지ㆍ예방을 요청하는 경우 회사는 당사자간의 분쟁이 해결되어 권리관계가 명확해질 때까지 해당 상품에 대한 삭제, 수정 또는 미노출 처리할 수 있습니다.
...
⑬ 회사가 구매자의 서비스 이용 편의를 높이기 위해 제휴업체로부터 정보를 제공받아 게재하거나 제3자가 제공하는 방식으로 녹녹 사이트 내 또는 링크 방식으로 참조용 정보나 콘텐츠를 제공할 수 있으며, 구매자는 상품 구매 때 자신의 판단과 책임으로 결정하여 구매하여야 합니다.
...
② 결제대금 보호 서비스는 녹녹에서 구매하는 모든 상품에 적용 됩니다.
...
⑩ 제3자에게 재판매하기 위한 목적으로 회사가 제공하는 혜택이나 할인률 등을 부당하게 이용하는 행위(다른 오픈마켓이나 인터넷쇼핑몰 등에 임의로 최저가를 등록하는 등으로 녹녹 할인쿠폰 발행을 유도한 후 해당 쿠폰을 적용하여 구매하는 행위 등), 회사에 손실을 발생시키는 행위는 금지되며, 재판매 목적의 거래행위가 확인된 경우 회사는 해당 회원에 대하여 서비스이용제한, 이용계약의 해지 등의 조치를 취할 수 있으며, 이러한 행위로 손해가 있을 경우 배상을 청구할 수 있습니다.
...
제31조 (기타 조항)
① 회사는 필요하면 특정 서비스나 기능의 전부 또는 일부를 녹녹 사이트를 통해 미리 공지한 후 일시적 또는 영구적으로 수정하거나 중단할 수 있습니다.
② 각 당사자는 상대방의 서면 동의 없이 이 약관상의 권리와 의무를 제3자에게 양도하거나 처분할 수 없습니다.
③ 이 약관과 관련하여 당사자 간의 합의에 따라 추가로 작성된 계약서, 협정서, 통보서 등과 회사의 정책변경, 법령의 제·개정 또는 공공기관의 고시나 지침 등에 따라 회사가 녹녹 사이트를 통해 공지하는 내용도 이용계약의 일부를 구성합니다.
④ 회사는 구매자 회원이 서비스를 이용할 때 발생할 수 있는 정당한 의견이나 불만 사항을 적극적으로 수렴하여 해결하고, 회원 상호 간의 분쟁을 조정하기 위하여 고객센터를 설치하고 운영합니다. 회사는 회원이 제기하는 각종 불만사항과 의견을 적극적으로 검토한 후 정당하다고 판단될 때에는 이를 신속하게 처리하며, 즉시 처리하기가 어려운 사항이 있으면 그 사유와 처리기간을 이메일(E-mail) 혹은 전화로 회원에게 통보 합니다.
                    ...
                    <ul class=" footBtwrap">
                    <button class="btn btn-secondary" style="width:140px;" id="myBtn" onclick="agree()">사업자로 등록하기</button>
					&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-secondary" style="width:140px; id="myBtn" onclick="agree2()">개인판매자로 등록하기</button>
					<br><br>
