        ...
        <div class="container">
            <div class="proposal-content">
                ...
                <div class="proposal-form">
                    <form method="POST" action="${cp }/campaign/proposal/submit.do" class="register-form" id="register-form" enctype="multipart/form-data">
                        <h2>캠페인 제안하기</h2>
            		   ...
            		   제안된 아이디어는 검토 후에 회원들의 펀딩 참여여부에 따라 다음회차 캠페인으로 선정됩니다.</p>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="cpKeyword1" id="pKeyword1" />
                            </div>
                            <div class="form-group">
                                <label for="keyword2">키워드2</label>
                                <input type="text" name="cpKeyword2" id="pKeyword2" />
                            </div>
                            <div class="form-group">
                                <label for="keyword3">키워드3</label>
                                <input type="text" name="cpKeyword3" id="pKeyword3" />
                            </div>
                        </div>
                         <div class="form-row1">
                           <div class="form-group">
