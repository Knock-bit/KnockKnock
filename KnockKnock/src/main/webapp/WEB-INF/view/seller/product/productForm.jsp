            ...
            <div class="proposal-content">
                ...
                <div class="proposal-form">
                    ...
                    action="${cp }/productSummer.do?" class="register-form" id="register-form" enctype="multipart/form-data">
                        <h2>상품 등록</h2>
                        <p>KNOCK!綠! 샵에 등록할 상품을 등록해주세요.</p>
                  
                        <div class="form-row1">
                              <div class="form-group">
                                  <input type="text" name="sIdx" value=${seller.sIdx } style="display:none;">
                        ...
                        <div class="form-submit">
                            <input type="button" value="취소" class="submit" name="reset" id="reset" onclick="location.href='${cp }/seller/sellerDashboard.do?sIdx=${seller.sIdx}'"/>
